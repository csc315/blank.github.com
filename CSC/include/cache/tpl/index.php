...
<div class="wpm">
  <div class="tab1 tab1b">
	<div id="top_banner" >
		 <ul class="slider" >
         <?php $vn=0;$tablev=syClass("syModel")->findSql("select * from csc_ads where isshow=1 and taid='1'  order by orders desc,id desc limit 3");foreach($tablev as $v){ $v["n"]=$vn=$vn+1; $v["name"]=stripslashes($v["name"]); ?>
...
<?php } ?>
  ...
  <div class="tab475">
  <?php $vn=0;$tablev=syClass("syModel")->findSql("select tid,molds,pid,classname,gourl,litpic,title,keywords,description,orders,mrank,htmldir,htmlfile,mshow from csc_classtype where  tid='1'  order by orders desc,tid");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["classname"]=stripslashes($v["classname"]);$v["description"]=stripslashes($v["description"]); $v["url"]=html_url("classtype",$v); ?>
  	<div class="type">
  ...
  <div class="tab980">
  	<div class="type">
    <p class="l"></p><p class="c f1">商品中心<span>Product Center</span></p><p class="r"></p><?php $vn=0;$tablev=syClass("syModel")->findSql("select tid,molds,pid,classname,gourl,litpic,title,keywords,description,orders,mrank,htmldir,htmlfile,mshow from csc_classtype where  tid='2'  order by orders desc,tid");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["classname"]=stripslashes($v["classname"]);$v["description"]=stripslashes($v["description"]); $v["url"]=html_url("classtype",$v); ?><a href="<?php echo $v['url'] ?>"></a><?php } ?>
    </div>
	<div class="tab1 tab1b">
        <div class="product">
            <div class="wrapper">
              <ul>
				<?php $vn=0;$tablev=syClass("syModel")->findSql("select * from csc_product where isshow=1 and tid in(2,18,19)  order by orders desc,addtime desc,id desc limit 10");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["url"]=html_url("product",$v); $v["title"]=stripslashes($v["title"]); $v["description"]=stripslashes($v["description"]); ?>
  ...
  <div class="tab220">
  	<div class="type">
    <p class="l"></p><p class="c f1">联系我们<span>Contact Us</span></p><p class="r"></p><?php $vn=0;$tablev=syClass("syModel")->findSql("select tid,molds,pid,classname,gourl,litpic,title,keywords,description,orders,mrank,htmldir,htmlfile,mshow from csc_classtype where  tid='7'  order by orders desc,tid");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["classname"]=stripslashes($v["classname"]);$v["description"]=stripslashes($v["description"]); $v["url"]=html_url("classtype",$v); ?><a href="<?php echo $v['url'] ?>"></a><?php } ?>
    </div>
  ...
  <div class="tab750">
  	<div class="type">
    <p class="l"></p><p class="c f1">服务案例<span>Service Case</span></p><p class="r"></p><?php $vn=0;$tablev=syClass("syModel")->findSql("select tid,molds,pid,classname,gourl,litpic,title,keywords,description,orders,mrank,htmldir,htmlfile,mshow from csc_classtype where  tid='4'  order by orders desc,tid");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["classname"]=stripslashes($v["classname"]);$v["description"]=stripslashes($v["description"]); $v["url"]=html_url("classtype",$v); ?><a href="<?php echo $v['url'] ?>"></a><?php } ?>
    </div>
	<div class="tab2">
        <ul class="case">
			<?php $vn=0;$tablev=syClass("syModel")->findSql("select * from csc_article where isshow=1 and tid in(4)  order by orders desc,addtime desc,id desc limit 4");foreach($tablev as $v){ $v["tid_leafid"]=$sy_class_type->leafid($v["tid"]);$v["n"]=$vn=$vn+1; $v["url"]=html_url("article",$v); $v["title"]=stripslashes($v["title"]); $v["description"]=stripslashes($v["description"]); ?>
			<li><a href="<?php echo $v['url'] ?>" target="_blank" style="<?php echo $v['style'] ?>"><img src="<?php echo $v['litpic'] ?>" /><p><?php echo newstr($v['title'],35) ?></p></a></li>
			<?php } ?>
        </ul> 
    </div>
...
<?php $tablev=syClass("syModel")->findSql("select * from csc_links where isshow=1  order by orders desc,id desc");foreach($tablev as $v){ $v["name"]=stripslashes($v["name"]); ?>
